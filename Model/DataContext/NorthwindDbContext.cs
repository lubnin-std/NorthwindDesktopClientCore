...
namespace NorthwindDesktopClientCore.Model.DataContext
{
    public partial class NorthwindDbContext : DbContext
    {
        ...
        public virtual DbSet<ТестНаРусскиеСимволы> ТестНаРусскиеСимволы { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer("Server=JohnyPC; Database=Northwind; Trusted_Connection=true;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ТестНаРусскиеСимволы>(entity =>
            {
                entity.HasNoKey();
                ...
                entity.Property(e => e.Идентификатор)
                    .HasMaxLength(10)
                    .IsFixedLength();
